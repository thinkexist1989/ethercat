...
#include "igc-6.8-ethercat.h"
#include "igc_hw-6.8-ethercat.h"
#include "igc_tsn-6.8-ethercat.h"
#include "igc_xdp-6.8-ethercat.h"
				       ...
				       struct igc_ring *tx_ring)
{
	...
	if (unlikely(!get_ecdev(adapter) &&
				test_bit(IGC_RING_FLAG_TX_HWTSTAMP, &tx_ring->flags) &&
